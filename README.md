...
# 📖 [Admission Trial Project] <a name="about-project"></a>

This is a Microverse admission trial project. 
...
```sh
  cd my-folder
git clone https://github.com/yawsamcode/admission-trial-project
```
...
- Twitter: [@twitterhandle](https://twitter.com/DimovTamara)
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/tamara-dimov-b85139a2/)
...
Thanks to coding partner Tamara Dimov, my coding partner during the 
Microverse admission stage. 
